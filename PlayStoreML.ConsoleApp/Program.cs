...
namespace PlayStoreML.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"H:\MlDataSet\AppleStore.csv";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Single Prediction --> Actual value: {sampleData.User_rating} | Predicted value: {predictionResult.Prediction} | Predicted scores: [{String.Join(",", predictionResult.Score)}]");
